...
"""
try:
    object_type = settings.TIMELINE_OBJECT_TYPE
...
if (object_type is None or object_type == 'DJANGO'):
    ...
    if object_type == 'WAGTAIL':
        ...
        class TimelineEventWithImageItem(
            ...
            page = ParentalKey(
                'django-kdl-timeline.TimelinePage',
                on_delete=models.CASCADE,
                related_name='related_events')

        class TimelinePage(AbstractTimelinePage):

            content_panels = Page.content_panels + [
                InlinePanel('related_events', label="Timeline Events"),
            ]

    elif object_type == 'WAGTAIL_DC':
        try:
