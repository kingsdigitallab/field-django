...
class ScoreBoard {
    ...
    toggleScoreboard(){
        ...
        if (this.scoreboardTitle.visible) this.scoreboardTitle.visible = this.visible;
        if (this.scoreboardPrompt.visible) this.scoreboardPrompt.visible = this.visible;
        if (this.scoreboardGroup.visible) this.scoreboardGroup.visible = this.visible;
        if (this.scoreboardBackground.visible) this.scoreboardBackground.visible = this.visible;
        if (this.scoreboardEdge.visible) this.scoreboardEdge.visible = this.visible;
