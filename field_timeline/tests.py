...
#                      'Agriculture Marketing Act (1933). It brought
#                      stability '
#                      'and financial security to dairy farmers by
#                      negotiating '
...
#                      'P FW PH1/OS/2/14',
#                      'Butter churn, Milk Marketing Board, Newbury,
#                      Berkshire',
#                      'Charles Topham',
...
#                      'https://doi.org/10.1016/0309-586X(78)90018-3;
#                      McQUEEN, '
...
#         test_date = {'display_date': 1933, 'year': 1933, 'month': 1,
#         'day': 1}
...
#                 'MMB) was a producer-led organisation established in
#                 1933-34 ' \
#                 '' \
#                 '' \
#                 'via the Agriculture Marketing Act (1933). It brought ' \
#                 'stability and financial security to dairy farmers by ' \
#                 'negotiating contracts with milk purchasers on behalf of
#                 all ' \
#                 '' \
#                 '' \
...
#         # and category
#         self.assertEqual(event.category.category_name, 'Production
#         Practices')
...
#                        'month': 1}, 'media': {
#             'url': 'http://www.reading.ac.uk/adlib/Details/archive
#             /110025847',
#             'caption': 'Butter churn, Milk Marketing Board, Newbury, '
#                        'Berkshire'},
